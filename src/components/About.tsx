        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-up">
            <p className="text-lg text-foreground/80 leading-relaxed">
                          I'm Henrique, a Web Developer who finds satisfaction
              in the challenge of bringing innovative ideas to life.            
              I specialize in creating unique and functional digital spaces.
            ...
            <p className="text-lg text-foreground/80 leading-relaxed">
              ...
              and high-performance web applications. I always
              prioritize adopting best practices and the latest market
              technologies to ensure the final product is both
              current and exceptionally fast.      
            </p>
               
          </div>
           
