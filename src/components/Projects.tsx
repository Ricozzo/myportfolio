  ...
  const projects = [
    {
      ...
      description: "This is a front-end and desktop-only game created for Ironhack's Web Development Bootcamp module The game was created by a team of two using tools such as HTML, CSS, JavaScript, and Canvas with a focus on creating a game using our knowledge of these technologies.",
      image: project1,
    ...
    {
      title: "Gallery Hub",
      description: "ith a focus on user engagement and functionality, I crafted a captivating gallery-themed platform. Within this environment, individuals have the power to curate, edit, and showcase their collections and items, allowing them to showcase their work in a truly unique and personalized manner.",
      image: project2,
    ...
    {
      title: "Social App",
      description: "Aplicação social com feed de posts, stories e sistema de mensagens em tempo real",
      image: project3,
